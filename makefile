...
#
# Fractals is free software: you can redistribute it and/or modify it under the
# terms of the GNU General Public License as published by the Free Software
# Foundation, either version 3 of the License, or (at your option) any later
# version.
#
# Fractals is distributed in the hope that it will be useful, but WITHOUT ANY
...
OPTIONS := -std=c++20 -D_POSIX_C_SOURCE=202207L -I$(SRCDIR) -Ilibs/stb\
